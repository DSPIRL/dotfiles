...
If a file needs to be sourced in config or elsewhere it mush be created before the script runs, if it's created at nu init time it can be put into the env to create the file before other shell configs are activated.
